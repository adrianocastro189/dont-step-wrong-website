...
El original probó el concepto. DSW2 lo expande en tres direcciones.

## Nuevas mecánicas

El primer juego tenía un conjunto limitado de tipos de regla, la mayoría numéricos. Si lo jugaste, conoces el patrón: miras los números en los bloques, pisas los que siguen la regla, fallas unas veces, lo descubres.

Don't Step Wrong 2 expande eso a decenas de categorías de reglas. Los patrones numéricos siguen ahí, pero comparten espacio con reglas basadas en palabras, restricciones de tiempo, conocimiento general y tipos que no voy a nombrar todavía. Las categorías se presentan solas conforme avanzas en el juego. No ves todo de una vez.

Lo que no cambia es el núcleo: sin tutorial, sin explicación, sin pistas por defecto. Observas, formulas una hipótesis, la pruebas.
...
Sí. Una demo gratuita está disponible en Steam ahora mismo. Cubre la primera zona y tiene suficientes niveles para que entiendas si el juego es para ti.

Si jugaste el original en itch.io, debería sentirse familiar, y lo suficientemente diferente como para que valga la pena.
